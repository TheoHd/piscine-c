...
typedef struct my_collation_handler_st
{
  ...
  /* Hash calculation */
  void (* hash_sort)(
      struct charset_info_st* cs, const uchar* key, uint len,
      ulong* nr1, ulong* nr2
  );
...
typedef struct my_charset_handler_st
{
  ...
  /* Unicode convertion */
  int (* mb_wc)(
      struct charset_info_st* cs, my_wc_t* wc,
  ...
  uint (* caseup)(
      struct charset_info_st*, char* src, uint srclen,
  ...
  int (* snprintf)(
      struct charset_info_st*, char* to, uint n, const char* fmt,
      ...
  );
  int (* long10_to_str)(
      struct charset_info_st*, char* to, uint n, int radix,
      long int val
  );
  int (* longlong10_to_str)(
      struct charset_info_st*, char* to, uint n,
  ...
  long (* strntol)(
      struct charset_info_st*, const char* s, uint l,
  ...
  double (* strntod)(
      struct charset_info_st*, char* s, uint l, char** e,
      int* err
  );
  longlong (* strtoll10)(
  ...
  ulong (* scan)(
      struct charset_info_st*, const char* b, const char* e,
      int sq
  );
} MY_CHARSET_HANDLER;
...
extern int my_strnxfrm_simple(
    CHARSET_INFO*, uchar*, uint, const uchar*,
    uint
);
uint my_strnxfrmlen_simple(CHARSET_INFO*, uint);
extern int my_strnncoll_simple(
    CHARSET_INFO*, const uchar*, uint,
    const uchar*, uint, my_bool
);

extern int my_strnncollsp_simple(
    CHARSET_INFO*, const uchar*, uint,
    const uchar*, uint,
    my_bool diff_if_only_endspace_difference
);
...
extern uint my_caseup_8bit(
    CHARSET_INFO*, char* src, uint srclen,
    char* dst, uint dstlen
);
extern uint my_casedn_8bit(
    CHARSET_INFO*, char* src, uint srclen,
    char* dst, uint dstlen
);
...
int my_snprintf_8bit(
    struct charset_info_st*, char* to, uint n,
    const char* fmt, ...
);

long my_strntol_8bit(
    CHARSET_INFO*, const char* s, uint l, int base,
    char** e, int* err
);
...
double my_strntod_8bit(
    CHARSET_INFO*, char* s, uint l, char** e,
    int* err
);
int my_long10_to_str_8bit(
    CHARSET_INFO*, char* to, uint l, int radix,
    long int val
);
int my_longlong10_to_str_8bit(
    CHARSET_INFO*, char* to, uint l, int radix,
    longlong val
);

longlong my_strtoll10_8bit(
    CHARSET_INFO* cs,
    const char* nptr, char** endptr, int* error
);
longlong my_strtoll10_ucs2(
    CHARSET_INFO* cs,
    const char* nptr, char** endptr, int* error
);
...
uint my_well_formed_len_8bit(
    CHARSET_INFO*, const char* b, const char* e,
    uint pos, int* error
);
...
extern uint my_caseup_mb(
    CHARSET_INFO*, char* src, uint srclen,
    char* dst, uint dstlen
);
extern uint my_casedn_mb(
    CHARSET_INFO*, char* src, uint srclen,
    char* dst, uint dstlen
);
...
extern my_bool my_parse_charset_xml(
    const char* bug, uint len,
