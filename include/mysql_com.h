...
struct sockaddr;
int my_connect(
    my_socket s, const struct sockaddr* name, unsigned int namelen,
...
void randominit(
    struct rand_struct*, unsigned long seed1,
    unsigned long seed2
);
...
my_bool check_scramble(
    const char* reply, const char* message,
